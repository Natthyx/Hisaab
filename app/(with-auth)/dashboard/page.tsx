...
import { getDashboardDataForCurrentUser } from "@/lib/dashboard/service"
...
async function DashboardContent({ searchParams }: { searchParams: Promise<{ account?: string }> }) {
  const params = await searchParams
  
  try {
    // Get dashboard data using the service function (user ID handled internally with caching)
    const {
      accounts,
      selectedAccount,
      selectedAccountId,
      ...
      weeklyData,
      monthlyData
    } = await getDashboardDataForCurrentUser(params.account)
