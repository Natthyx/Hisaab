...
async function AnalyticsContent(props: { searchParams: Promise<{ account?: string }> }) {
...
export default function AnalyticsPage(props: { searchParams: Promise<{ account?: string }> }) {
  return (
